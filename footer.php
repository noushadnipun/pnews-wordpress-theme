...
<div id="" class="eql"><div id="widget18473" class="breaking_light_blue"><div class="mobile"> <div class="break_news_caption">

<!--
<img src="http://kantha71.com/wp-content/uploads/2017/02/headline.gif"/>
-->
 ...
 </div> </div> <div class="break_news"> <marquee align="top" behavior="scroll" direction="left" onMouseOut="this.start();" onMouseOver="this.stop();" scrollamount="3" scrolldelay="20" >
...
<a href="' . get_permalink($post["ID"]) . '" title="দেখতে ক্লিক করুন: '.$post["post_title"].'" >'.   $post["post_title"].  '</a>';
	}
?>
-->
 <?php query_posts('showposts=10'); if ( have_posts() ) : while ( have_posts() ) : the_post();  ?>
										 ...
										 <img src="http://pnews24.com/spidysoft-application/uploads/2018/09/p-icon.png" alt="Icone" style="width:12px;height:12px;"/>   <a href="<?php the_permalink(); ?>"><?php echo get_post_meta(get_the_ID(), $prefix.'article-ticker', true); ?></a>
