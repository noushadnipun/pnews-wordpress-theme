...
">                          
         ...
         <div id="focus" style="
    height: 328px;
    border-top: 2px solid #da0909;
    border-radius: 3px;
    border-bottom: 2px solid #da0909;
">
                        ...
                        <div class="focus-heading-container">
                           <h2><?php the_title(); ?></h2>
                           <p style="text-align:justify"><?php hr_content_limit(400)?></p>					
                        </div>
                        </a>
                  </div>
				  <?php endwhile; ?>
         ...
         <aside class="col-sm-12 pl12pr0">
            <div class="row">
               <div class="col-sm-12">
                   ...
                   <?php include '1slider-section.php'; ?>
