               ...
               <div class="row">
                  <div class="col-sm-12 pl-0 pr-12">
                     <div class="bd-news-heading-container">
                        <div class="main-heading"><a style="font-size: 16px; color: #fff;" href="<?php echo get_category_link( $spidysoft['after-lead-section-left-cat'] ); ?>"><?php echo $afterladsectionleftcatname ;?></a></div>
