...
//----------------//
 ...
 $secondblackbgcatname = get_the_category_by_id($spidysoft['1st-black-bg-section-left-cat']);

 
/* use catslug function*/
 
  global $secondblackbgcatslug;
 $secondblackbgcatslug =  get_cat_slug( $spidysoft['1st-black-bg-section-left-cat'] );
   ...
   <div class="container">
      <div class="row">
         <div class="col-sm-12 entertainment-heading">
			<div style="background: #333; text-align: center;"><a href="<?php echo get_category_link( $spidysoft['1st-black-bg-section-left-cat'] ); ?>" style="font-size: 30px; color: #fff;"><?php echo $secondblackbgcatname; ?></a></div>
         </div>
      </div>
      <div class="row">
