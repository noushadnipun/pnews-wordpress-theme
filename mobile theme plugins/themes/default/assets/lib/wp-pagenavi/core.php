...
class PageNavi_Core {
	...
	static function stylesheets() {
		...
		if ( @file_exists( get_stylesheet_directory() . '/assets/lib/wp-pagenavi/pagenavi-css.css' ) )
			$css_file = get_stylesheet_directory_uri() . '/assets/lib/wp-pagenavi/pagenavi-css.css';
		elseif ( @file_exists( get_template_directory() . '/assets/lib/wp-pagenavi/pagenavi-css.css' ) )
			$css_file = get_template_directory_uri() . '/assets/lib/wp-pagenavi/pagenavi-css.css';
		else
