...
//----------------//
 ...
 global $mobilenewscatname2;
      
 $mobilenewscatname2 = get_the_category_by_id($spidysoft['mobile-news-cat-2']);
 
/* use catslug function*/
 
 global $mobilenewscatslug2;
 $mobilenewscatslug2 =  get_cat_slug( $spidysoft['mobile-news-cat-2'] );
...
<div id="div_75731" class="col-md-12">
   <div class="inner">
      <div class="news-cat-title">
         <h2><a href="<?php echo get_category_link( $spidysoft['mobile-news-cat-2'] ); ?>"><?php echo $mobilenewscatname2; ?></a></h2>
      </div>
                     ...
                     <div class="contents_listing  widget">
                        <div class="contents  summery_view 
                           ...
                           <div class="">
                              <div class="col col1">
							    <?php  
								  $mobilenewscatposttwo = new WP_Query(array(
								  'post_type' => 'post',
								  'posts_per_page' => 1,
								  'category_name'  => $mobilenewscatslug2
								  ));   
								  while($mobilenewscatposttwo->have_posts()) :  $mobilenewscatposttwo->the_post(); ?>
									...
									<?php  
									  ...
									  while($mobilenewscatposttwo->have_posts()) :  $mobilenewscatposttwo->the_post(); ?>
									   ...
									   <div style="padding: 10px; background: #fff; border: 1px solid #ccc; text-align: center; font-size: 18px;">
									     <a href="<?php echo get_category_link( $spidysoft['mobile-news-cat-2'] ); ?>">এ বিভাগের আরও খবর</a>
									   </div>
