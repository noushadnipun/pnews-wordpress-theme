...
//----------------//
 ...
 global $mobilenewscatname7;
      
 $mobilenewscatname7 = get_the_category_by_id($spidysoft['mobile-news-cat-7']);
 
/* use catslug function*/
 
 global $mobilenewscatslug7;
 $mobilenewscatslug7 =  get_cat_slug( $spidysoft['mobile-news-cat-7'] );
...
<div id="div_75731" class="col-md-12">
   <div class="inner">
      <div class="news-cat-title">
         <h2><a href="<?php echo get_category_link( $spidysoft['mobile-news-cat-7'] ); ?>"><?php echo $mobilenewscatname7; ?></a></h2>
      </div>
                     ...
                     <div class="contents_listing  widget">
                        <div class="contents  summery_view 
                           ...
                           <div class="">
                              <div class="col col1">
							    <?php  
								  $mobilenewscatpostseven = new WP_Query(array(
								  'post_type' => 'post',
								  'posts_per_page' => 1,
								  'category_name'  => $mobilenewscatslug7
								  ));   
								  while($mobilenewscatpostseven->have_posts()) :  $mobilenewscatpostseven->the_post(); ?>
									...
									<?php  
									  ...
									  while($mobilenewscatpostseven->have_posts()) :  $mobilenewscatpostseven->the_post(); ?>
									   ...
									   <div style="padding: 10px; background: #fff; border: 1px solid #ccc; text-align: center; font-size: 18px;">
									     <a href="<?php echo get_category_link( $spidysoft['mobile-news-cat-7'] ); ?>">এ বিভাগের আরও খবর</a>
									   </div>
